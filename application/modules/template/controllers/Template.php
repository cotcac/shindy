...
class Template extends MX_Controller {
    ...
    function nav($data)
    {
       ...
       if(!isset($data['title'])){
           $data['title']='Shindy korea';//default title
       }
       if(!isset($data['keyword'])){
           $data['keyword']='gagucall';//default keyword
       }
       if(!isset($data['description'])){
           $data['description']='gagucall';//default description
       }
    ...
    function no_footer($data){
       ...
       if(!isset($data['title'])){
           $data['title']='gagucall';//default title
       }
       if(!isset($data['keyword'])){
           $data['keyword']='gagucall';//default keyword
       }
